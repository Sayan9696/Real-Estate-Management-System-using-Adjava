...
*/div.myc{
	...
	background:#004d4d;padding:10px;
	text-align:center;
...
<%try{
	...
	String pname=request.getParameter("sn");
	

	String sql="select * from PROPERTY where PADDR=?";
...
%>
 ...
 <a href="Propertyview.jsp?rd=<%=rs.getString(2)%>"><img src="<%=rs.getString(9)%>" height="200px" width="280px"><br><%=rs.getString(2) %><br><%=rs.getString(7)%><br><%=z %>lac rupees</a>
</div>
