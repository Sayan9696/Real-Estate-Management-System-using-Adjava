...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
       ...
       <center><h2>YOUR COMPLAIN SUCCESSFULLY SAVED IN DATABASE</h2></center>
...
try{
	...
	if(cm.equals("")||nm.equals("")||ml.equals("")||ph.equals(""))
	{out.print("please fill the form");
		RequestDispatcher rd=request.getRequestDispatcher("customer_service.html");
		rd.include(request,response );
		out.print("please give id");
	
	}else{
		int id=0;
		PreparedStatement p=cn.prepareStatement("select max(ID) from CMP");
