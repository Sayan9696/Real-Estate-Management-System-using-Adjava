...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>RentProperty</u></b></h2>
...
<%try{
	...
	String s=request.getParameter("rh");
	int x=Integer.parseInt(s);
	//String y=request.getParameter("z");
	//int f=Integer.parseInt(y);
	//int s1=Integer.parseInt("s");
    //int s2=Integer.parseInt("f");
	String sql="select * from RENT where RPRICE<=? order by RPRICE ";
...
%>
 ...
 <a href="Rentview.jsp?rd=<%=rs.getString(1)%>"><img src="<%=rs.getString(9)%>" height="225px" width="280px"><br><u><%=rs.getString(2) %></u><br><%=z%>K Rs<br><%=rs.getString(6) %></a></div>
