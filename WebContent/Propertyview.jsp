...
div.myc{
	...
	background:  #00004d;padding:10px;
	text-align:center;
...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
      ...
      <h2 class="w3-left w3-text-light-green"><b><u>View Property</u></b></h2>
      
     
 
<title>PropertyView page</title>
</head>
<body>
...
<%try{
	...
	String sql="select * from PROPERTY where PNAME=?";
  ...
  <h3 class="w3-text-deep-green"></h3>
</div></p></b></div>
   ...
   <div class="myc" height="280px" width="500px" >
   <img src="<%=rs.getString(8)%>"  height="300px" width="425px">
   </div>
     <h5 class="w3-left w3-text-light-pale-red"><b> <center>Bed Room</center></b></h5>
</div>


<div class="w3-half w3-container w3-center">
  <div class="myc" height="280px" width="500px" >
   <img src="<%=rs.getString(9)%>" height="300px" width="425px">
   </div>
     <h5 class="w3-left w3-text-light-pale-red"><b> <center>Drawing Room</center></b></h5>
</div>
...
<%
	...
	out.print("<u><b><h3>"+rs.getString(2)+"</h3></u></b>"+"    <br>   price:"+z+"lac Rupees"+"<br>");
	out.print("Property Type:"+rs.getString(3)+"     <br>   Property Area: "+rs.getString(4)+"<br>");
	
	out.print("Location:"+rs.getString(5)+"      "+rs.getString(7)+"<br>");
...
<div class="w3-container w3-Black  w3-row w3-panel w3-topbar w3-bottombar w3-border-gray">
	...
	out.print("Builder ID: "+rs.getString(13)+"     <br>   Builder name: "+rs.getString(14)+"<br>");

	out.print("contact no: "+rs.getString(15)+"     <br> Builder address: "+rs.getString(16)+"<br>"); 
	}	%>
</div>	
	<%
}
