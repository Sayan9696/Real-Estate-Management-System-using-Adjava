...
div.myc{
	...
	background: #002633;padding:10px;
	text-align:center;
...
hr.new4 {
  ...
  <div class="w3-bar w3-purple w3-border">
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Block Rent Property</u></b></h2>
    <hr class="new4">
...
%><div class="myc" height="240px" width="300px" style="float:left;margin:25px">
 <a href="deleteRent.jsp?rd=<%=rs.getString(1)%>"><img src="<%=rs.getString(9)%>" height="225px" width="280px"><br><u><%=rs.getString(2) %></u><br><%=rs.getString(7)%>Rs<br><%=rs.getString(6) %></a>
</div>
