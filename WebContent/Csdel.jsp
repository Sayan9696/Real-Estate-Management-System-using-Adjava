...
hr.new4 {
  ...
  <div class="w3-bar w3-purple w3-border">
       ...
       <a href="Cusprofile.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Upadated list</a>
      ...
      <center><h2>THE CUSTOMER NOW BLOCKED</h2></center>

<%@page import="pack.*,java.sql.*" %>
<% Connection cn=GetD.getC();
		try{
			String ad=request.getParameter("ch");
