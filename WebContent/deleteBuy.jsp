...
hr.new4 {
  ...
  <div class="w3-bar w3-purple w3-border">
       ...
       <a href="BlockBuy.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Upadated Property</a>
      ...
      <center><h2>SELECTED PROPERTY DELETED FROM DATABASE </h2></center>

<%@page import="pack.*,java.sql.*" %>
<% Connection cn=GetD.getC();
		try{
			String ad=request.getParameter("rd");
			String sql="delete from PROPERTY where PNAME=?";
