...
.button {
  ...
  <div class="w3-bar w3-purple w3-border">
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Customer Complain Box</u></b></h2>
  <hr class="new4">
...
try{
	...
	String sql="select * from CMP  order by ID desc";
...
<font color:red>COMPLAIN ID:</font><%=rs.getString(1) %><br>
<font color:red>CUSTOMER NAME:</font><%=rs.getString(2) %><br>
<font color:red>COMPLAIN MAIL:</font><%=rs.getString(3) %><br>
<font color:red>CUSTOMER PHN:</font><%=rs.getString(4) %><br>
<font color:red>COMPLAIN:</font><%=rs.getString(5) %><br>
<hr class="new5">
<%} %>
