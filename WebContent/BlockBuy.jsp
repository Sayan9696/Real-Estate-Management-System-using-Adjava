...
hr.new4 {
  ...
  <div class="w3-bar w3-purple w3-border">
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Block Buy Property</u></b></h2>
...
%><div class="myc" height="250px" width="300px" style="float:left;margin:25px">
 <a href="deleteBuy.jsp?rd=<%=rs.getString(2)%>"><img src="<%=rs.getString(9)%>" height="240px" width="285px"><br><u><%=rs.getString(2) %></u><br><%=rs.getString(7)%><br><%=z%>lac Rs</a>
</div>
