...
*/div.myc{
	...
	background:#1f2e2e;padding:10px;
	text-align:center;
...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>View SearchProperty</u></b></h2>
...
<table>
<tr><td>PROPERTY NAME</td><td>         </td><td>PRICE</td><td>LOCATION</td></tr>
<%@page import="pack.GetD,java.sql.*" %>


<%try{
	Connection cn=GetD.getC();
	String pname=request.getParameter("zn");
	String sql="select * from PROPERTY where BHK=?";
...
%>
	...
	//out.print(rs.getString(2)+"     "+rs.getString(3)+"Rupees"+"<br>");
	%>
	<tr><div class="myc" height="220px" width="300px" style="float:left;margin:25px">
 <a href="Propertyview.jsp?rd=<%=rs.getString(2)%>"><img src="<%=rs.getString(9)%>" height="200px" width="280px"><br><%=rs.getString(2) %><br><%=rs.getString(7)%><br><%=z %>lac rupees<br><%=rs.getString(12)%></a>
</div>
...
<a href="www.naukri.com">Naukri.com</a>     <br>
<a href="www.Naukrigulf.com ">Naukrigulf.com </a>     <br>
<a href="www.Jeevansathi.com">Jeevansathi.com</a>     <br>
<a href="www.Brijj.com">link text</a>     <br>
<a href="www.Shiksha.com">Shiksha.com</a>     <br>
<a href="www.Policybazaar.com">Policybazaar.com</a>     <br>
<a href="www.PaisaBazaar.com">PaisaBazaar.com</a>     <br>
<a href="www.AmbitionBox.com">AmbitionBox.com</a>     <br>
</div>
