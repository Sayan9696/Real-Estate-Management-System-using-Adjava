...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Rent Property</u></b></h2>
    <hr class="new4">
...
%><div class="myc" height="240px" width="300px" style="float:left;margin:25px">
 <a href="Rentview.jsp?rd=<%=rs.getString(1)%>"><img src="<%=rs.getString(9)%>" height="225px" width="280px"><br><u><%=rs.getString(2) %></u><br><%=rs.getString(7)%>Rs<br><%=rs.getString(6) %></a>
</div>
