...
*/div.myc{
	...
	background: #664400;padding:10px;
	text-align:center;
...
<%try{
	...
	String pname=request.getParameter("fn");
	String sql="select * from RENT where RLOC=?";
...
%>
 ...
 <a href="Rentview.jsp?rd=<%=rs.getString(1)%>"><img src="<%=rs.getString(9)%>" height="200px" width="280px"><br><%=rs.getString(2) %><br><%=z%>k rupees<br><%=rs.getString(6) %></a>
</div>
