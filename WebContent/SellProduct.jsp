...
<div class="w3-overlay-white w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
  ...
  style="font-size: 15px;color: white;" onclick="w3_open()"><i class="fa fa-bars"></i></a>
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Sell Property</u></b></h2>
    <h4 class="w3-text-light-green"><b><u>do you want to sell your property?</u></b></h4>
    <h4 class="w3-text-light-green"><b><u>please do fill the form</u></b></h4>
...
<form action=Sell.jsp>
  ...
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n1" name="n1" placeholder="enter property name"></p>
   <p><input class="w3-input w3-border w3-hover-black" type="text" id="n2" name="n2" placeholder="enter property type"></p>
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n3" name="n3" placeholder="enter property area"></p>
 <p><input class="w3-input w3-border w3-hover-black" type="text" id="n4" name="n4" placeholder="enter property location"></p>
 
 
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n5" name="n5" placeholder="enter property Price"></p>
   <p><input class="w3-input w3-border w3-hover-black" type="text" id="n6" name="n6" placeholder="enter property address"></p>
  <p><input class="w3-input w3-border w3-hover-black" type="file" id="n7" name="n7" placeholder="select bedroom image"></p>
 <p><input class="w3-input w3-border w3-hover-black" type="file" id="n8" name="n8" placeholder="select drawing room image"></p>
 
 
  <p><input class="w3-input w3-border w3-hover-black" type="file" id="n9" name="n9" placeholder="select building image"></p>
   <p><input class="w3-input w3-border w3-hover-black" type="text" id="n10" name="n10" placeholder="enter property description"></p>
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n11" name="n11" placeholder="enter property bhk"></p>
 <p><input class="w3-input w3-border w3-hover-black" type="text" id="n12" name="n12" placeholder="enter property builder id"></p>
 
 
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n13" name="n13" placeholder="enter property builder name"></p>
   <p><input class="w3-input w3-border w3-hover-black" type="text" id="n14" name="n14" placeholder="enter property builder mail"></p>
  <p><input class="w3-input w3-border w3-hover-black" type="text" id="n15" name="n15" placeholder="enter property builder address"></p>
 
  <center><input type="submit" class="button" value="save" onclick="age()"><br></center>
</form>
