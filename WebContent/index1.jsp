  ...
  border: 1px solid white;
    ...
    <div class="w3-display-container">
      <div class="w3-bar w3-deep-purple w3-border">
        ...
        <button href="index1.jsp" class="w3-bar-item w3-btn w3-center w3-mobile logo">Makanmalik.com<img src="image/d.png" alt="" style="width: 20px"></button>
        ...
        <a href="SellProduct.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Sell Property</a>
