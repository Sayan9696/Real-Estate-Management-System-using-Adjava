...
.button {
  ...
  <div class="w3-bar w3-purple w3-border">
        ...
        <a class="w3-bar-item w3-mobile w3-right" style="width: 50px;"></a>
     ...
     <br>
     <br>   <h2 class="w3-center w3-text-light-green"><b><u>Customer Data</u></b></h2>
    <h4 class=" w3-text-light-green"><b><u>do you want to block any customer account?</u></b></h2>
    
    <h4 class=" w3-text-light-green"><b><u>please select the customer in this following list.</u></b></h2>
<hr class="new4">
...
<form action="Csdel.jsp">
<table>
<tr><td>CUSTOMER ID</td><td>CUSTOMER NAME</td><td>PHN NO</td><td>MAIL ID</td><td>ADDRESS</td><td>select</td></tr>
...
<td><input type="radio" name="ch" value="<%=rs.getString(1)%>" ></td>
</tr>
<%} %>
<tr>
<%}catch(Exception e){
...
<input type="submit" class="button" value="block"><br>
</form>
</div>
