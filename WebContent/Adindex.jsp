  ...
  border: 1px solid white;
    ...
    <div class="w3-display-container">
      <div class="w3-bar w3-deep-purple w3-border">
        ...
        <button href="Adindex.html" class="w3-bar-item w3-btn w3-center w3-mobile logo">Makanmalik.com<img src="image/d.png" alt="" style="width: 20px"></button>
...
<a href="Adlogin.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Logout</a>
         <a href="Complain.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Complains</a>
        
        <a href="Cusprofile.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Customer Details</a>
        <a href="BlockRent.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Block Rent Property</a>
        <a href="BlockBuy.jsp" class="w3-bar-item w3-btn w3-center w3-mobile w3-right logo">Block Buy Property</a>
      </div>
...
try{
	...
	{
		RequestDispatcher rd=request.getRequestDispatcher("Adlogin.html");
		rd.include(request,response );
		out.print("please give id");
	
	}else{
	String sql="select * from CUSTOMER where CMAIL=? and CPASS=?";
